    ...
    return (
        <div>
            <div className="rc-drawer rc-drawer-left rc-drawer-open" tabIndex={-1}>
                ...
                />
                <div className="rc-drawer-content-wrapper" style={{width: 378, left: 0}}>
                    <div
                    ...
                    >
                        <div className="flex flex-col justify-between w-full h-full">
                            <div
                                className="bg-gray-300 w-full border-b border-border-base flex justify-between items-center relative ltr:pl-5 rtl:pr-5 md:ltr:pl-7 md:rtl:pr-7 shrink-0 py-0.5">
                            ...
                            <div
                                className="flex items-center justify-center py-5 -mx-3 border-t text-brand-light border-border-base px-7 shrink-0">
                                <a
